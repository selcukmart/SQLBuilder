...
trait SQLVariablesTrait
{
    protected $reserved = [
        'ABS', 'ACOS', 'ADDDATE', 'ADDTIME', 'AES_ENCRYPT', 'AES_DECRYPT', 'AGAINST', 'ASCII',
    ...
    protected $parameterizedFunctions = [
    ...
    protected $aggregateFunctions = [
        'AVG', 'SUM', 'COUNT', 'MIN', 'MAX', 'STD', 'STDDEV', 'STDDEV_SAMP',
        'STDDEV_POP', 'VARIANCE', 'VAR_SAMP', 'VAR_POP', 'GROUP_CONCAT', 'BIT_AND',
        'BIT_OR', 'BIT_XOR'
    ];

    protected $conditions = [
        'AND', 'OR', 'XOR', '||', '&&', 'BETWEEN', 'NOT BETWEEN'
    ];
    ...
    public function commandPrepare($command)
    {
        ...
        if (in_array($command, $this->conditions)) {
            return 'CONDITION';
        }
        return $command;
    }
